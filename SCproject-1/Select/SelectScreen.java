...
public class SelectScreen extends JFrame {
    ...
    private void handleProjectConfirm() {
        ...
        if (selected.contains("Assigned")) {
            JOptionPane.showMessageDialog(this, "This project is already assigned.", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        }

        // Mark as assigned
        assignedProjects.add(selected);
        JOptionPane.showMessageDialog(this, "Project '" + selected + "' selected successfully!", "Success", JOptionPane.INFORMATION_MESSAGE);
        updateProjectList();
    }
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new SelectScreen());
    }
}
