...
public class ReceiveFeedbackScreen extends JFrame {
    ...
    private String currentScreen = "ReceiveFeedback";
    ...
    public ReceiveFeedbackScreen() {
        ...
        // ✅ Use project title from session
        String projectTitle = SessionManager.projectTitle != null ? SessionManager.projectTitle : "Unknown Project";

        // Top Panel
        JPanel selectionPanel = new JPanel(new GridLayout(3, 2, 10, 10));
        selectionPanel.setBackground(new Color(255, 253, 208));
        ...
        lblProjectTitle = new JLabel(projectTitle);
        lblProjectTitle.setFont(new Font("SansSerif", Font.BOLD, 15));
        ...
        selectionPanel.add(lblProjectTitle);
    ...
    private void loadFeedback() {
        String project = lblProjectTitle.getText();
        String version = (String) cbVersion.getSelectedItem();

        if (version.equals("Select Version")) {
    ...
    public static void main(String[] args) {
        // Simulate login
        SessionManager.currentUser = new User("Ali", "ali@mail.com", "pass123", "Student", "s_001", 21);
        SessionManager.projectTitle = "AI Chatbot"; // ✅ Also set this here
